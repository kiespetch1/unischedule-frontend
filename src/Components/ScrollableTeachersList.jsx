...
const ScrollableTeacherList = ({handleTeacherAdd, teachers, handleTeacherPick, isAddingTeachers, handleTeacherSave}) => {
                ...
                <div className="scroll-container"
                    ...
                    <div ref={contentRef} style={{
                        ...
                        {teachers.map((item, index) => (
                            <div key={index} onClick={() => handleTeacherPick(item.fullName)}
...
export default ScrollableTeacherList;