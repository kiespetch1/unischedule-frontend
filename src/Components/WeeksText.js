    ...
    return (
        <div className="week-container">
            ...
            {!isWeekEven() ? (currentWeekType === "odd" ? <div>
                <div className="week-text" onClick={setWeekEven} style={{marginBottom: "7px", cursor: "pointer"}} title="Посмотреть расписание для четной недели1" >
                ...
                <div className="week-text" onClick={setWeekOdd} style={{cursor: "pointer"}} title="Посмотреть расписание для нечетной недели2">
                    <GetNextWeekText
                        date={new Date(new Date().setDate(new Date().getDate() + 7))}/>
                </div>
                ...
                <div className="week-text" onClick={setWeekEven} style={{cursor: "pointer"}} title="Посмотреть расписание для четной недели4">
                    <GetNextWeekText
                        date={new Date(new Date().setDate(new Date().getDate() + 7))}/>
                </div>
            </div> : <div>
                <div className="week-text" onClick={setWeekOdd} style={{cursor: "pointer", marginBottom: "7px"}} title="Посмотреть расписание для нечетной недели3">
                    <GetCurrentWeekText date={new Date()}/>
                </div>
                <div className="week-text" style={{fontWeight: "600"}}>
                    <GetNextWeekText
