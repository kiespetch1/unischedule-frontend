...
const TopClass = ({classType, weekType, subgroup, name, startTime, endTime, teacherId, locationId}) => {
        ...
        <section className="day-block-top">
            <div className="main-content">
                <div className="info-row">
                    ...
                    {(weekType === 0 && subgroup === 0 ? null : <DotDivider style={windowWidth <= 930 ? dotSmallStyle : dotStyle}/>)}
                    {(weekType === 0 ? null
